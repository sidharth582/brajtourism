...
export function Welcome() {
  ...
  const packageDetails = [
    ...
    },
    {
      ...
      duration: "1 Day",
      itinerary: `📍 Pickup & Drop: Mathura Railway Station / Hotel\n🚗 Private Cab | Local Assistance | Safe Holi Guidance\n\n✔ Private Cab (Full Day – 8 to 10 hrs)\n✔ Pickup & Drop – Mathura\n✔ Local Guide / Holi Assistance\n\n\nRangotsav 2026 – Braj Holi Festival Schedule\n\n 24 Feb 2026 (Tuesday) – Phag Invitation, Nandgaon\n 24 Feb 2026 (Tuesday) – Laddu Holi, Barsana\n 25 Feb 2026 (Wednesday) – Lathmar Holi, Barsana\n 26 Feb 2026 (Thursday) – Lathmar Holi, Nandgaon\n 26 Feb 2026 (Thursday) – Rang Lathmar Holi, Village Raval\n 27 Feb 2026 (Friday) – Ashtami Holi (at Shri Krishna Janmasthan), Mathura\n   • Color Holi at Shri Banke Bihari Temple, Vrindavan\n   • Kesariya (Saffron) Holi at Shri Dwarkadhish Temple, Mathura\n\n 1 Mar 2026 (Sunday) – Chhadimar Holi, Gokul\n 3 Mar 2026 (Tuesday) – Chaturvedi Samaj Dola, Mathura\n 3 Mar 2026 (Tuesday) – Holika Dahan (Auspicious Brahma Muhurat), Village Phalen\n 4 Mar 2026 (Wednesday) – Dhulandi (Color Playing Day), Mathura\n 5 Mar 2026 (Thursday) – Dauji ka Huranga, Baldev\n    • Huranga, Nandgaon\n    • Huranga, Bachhgaon\n    • Huranga, Jao\n 6 Mar 2026 (Friday) – Huranga, Village Bachhgaon\n 6 Mar 2026 (Friday) – Huranga, Vigah\n 9 Mar 2026 (Monday) – Chhadimar Holi, Mahavan\n 12 Mar 2026 (Thursday) – Holi at Shri Rangji Temple, Vrindavan\n\nWarm welcome to Braj Holi 2026!`
    },
  ];
  ...
  function handleIframeLoad() {
    ...
    if (submitting) {
      ...
      setEmail("");
      setPhone("");
      // hide the success message after 3 seconds and close modal if open
      if (timerRef.current) {
    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section id="packages" className="container mx-auto px-6 py-12">
          ...
          <article className="border rounded-lg overflow-hidden shadow-sm bg-white">
            ...
            <div className="p-4">
              ...
              <div className="mt-4 flex gap-3">
                <button
                  className="flex-1 rounded-md border border-blue-500 text-blue-500 px-3 py-2 text-sm" type="button" onClick={() => setShowEnquiryModal(true)}>Enquire Now</button>
                <button
                  type="button"
        ...
        {selectedPackage !== null && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative max-w-lg w-full bg-white rounded-lg shadow-lg p-9 m-4">
              <button
                onClick={closeModal}
        ...
        {showEnquiryModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            <div className="relative bg-white rounded-xl shadow-xl p-8 w-full max-w-md mx-auto">
              <button
                onClick={closeModal}
                className="absolute top-4 right-4 text-2xl text-blue-700 border-2 border-blue-700 rounded-full w-8 h-8 flex items-center justify-center hover:bg-yellow-50"
                aria-label="Close"
                style={{ lineHeight: 1 }}
              >
                ×
              </button>
              <h2 className="text-3xl font-bold text-center mb-6 mt-2" style={{ fontFamily: 'inherit' }}>Enquire Now</h2>
              <iframe
                title="hidden-form-target-enquiry"
                name="hidden_iframe_enquiry"
                ref={iframeRef}
                style={{ display: "none" }}
                onLoad={handleIframeLoad}
              />
              ...
              >
                ...
                <input
                  ...
                  value={name}
                  onChange={e => setName(e.target.value)}
                  className="w-full rounded-full border border-gray-300 px-6 py-4 text-lg focus:outline-none focus:ring-2 focus:ring-orange-400"
                ...
                <button
                  type="submit"
                  className="w-full rounded-md bg-blue-500 text-white py-4 text-lg font-semibold mt-2 hover:bg-blue-600 transition"
                  style={{ fontFamily: 'inherit' }}
                  disabled={submitting}
                  aria-busy={submitting}
                >
              ...
              {submitted && (
                <div className="mt-4 rounded-md bg-emerald-50 border border-emerald-100 p-3 text-sm text-emerald-700 text-center">
                  Thanks — your enquiry was submitted. You will be contacted shortly by our team!
                </div>
              )}
            </div>
      ...
      <section id="contact" className="container mx-auto px-6 py-16">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <a href="https://www.instagram.com/exploremathuravrindavan?igsh=MWl2b3BoaXl6amJ2bw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center group">
          ...
          <a href="tel:+918445731077" className="flex flex-col items-center group">
            <span className="bg-green-600 rounded-full p-4 mb-2">
              <svg
                className="w-8 h-8 text-white"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
                <path d="M6.62 10.79a15.91 15.91 0 006.59 6.59l2.2-2.2a1 1 0 011-.24c1.12.37 2.33.57 3.59.57a1 1 0 011 1V20a1 1 0 01-1 1C10.3 21 3 13.7 3 4a1 1 0 011-1h3.5a1 1 0 011 1c0 1.26.2 2.47.57 3.59a1 1 0 01-.25 1l-2.2 2.2z" />
              </svg>
            </span>
          ...
          <a href="https://www.instagram.com/exploremathuravrindavan?igsh=MWl2b3BoaXl6amJ2bw%3D%3D&utm_source=qr" className="flex flex-col items-center group">
